...
name = 'shock_routes_1_50_h05_h11'
model_name = 'eval_models'
config = {
    "episode": {
    ...
    "environment": {
        ...
        "gui": False,
        "yellow_duration": 3,
        "episode_start_time": 17100,
        "episode_length_time": 22500,
        "is_record": True,
        "name": name,
        'output_path_head': 'sumo_files/scenarios/sumo_fenglin_base_sub4/eval_logs/{}/'.format(name),
        "route_dir": "sumo_fenglin_base_sub4",
        "sumocfg_files": [
            ...
            "sumo_files/scenarios/sumo_fenglin_base_sub4/base.sumocfg",
    ...
    "model_save": {
        ...
        "path": "tsc/{}/".format(model_name),#模型保存的地址
    },
    "parallel": {
        "num_workers": 1
    }
