...
SHOCK_2P0_ROUTE_DIR="$ROOT/$SUB5_SCENARIO/shock_2p0_h07_h08"
SHOCK_2P5_ROUTE_DIR="$ROOT/$SUB5_SCENARIO/shock_2p5_h07_h08"
...
for SEGMENT in h00_h06 h06_h12 h12_h18 h18_h24; do
  ...
  BASELINE_CONDITION="sub5_baseline_real_${ROUTES}_${MODEL_TAG}_${SEGMENT}"
  SHOCK_2P0_CONDITION="sub5_shock_2p0_${ROUTES}_${MODEL_TAG}_${SEGMENT}"
  SHOCK_2P5_CONDITION="sub5_shock_2p5_${ROUTES}_${MODEL_TAG}_${SEGMENT}"
...
plot_case() {
  ...
  local output_dir="$ROOT/$SUB5_SCENARIO/analysis_plots/${ROUTES}_h00_h24_5min_${MODEL_TAG}_${shock_label}"
  mkdir -p "$output_dir"
